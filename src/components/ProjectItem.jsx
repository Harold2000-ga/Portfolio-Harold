...
export const ProjectItem = ({ title, image, projectUrl, description }) => {
  return (
    <div className='relative  bg-secondary flex items-center justify-center h-auto w-full shadow-xl  shadow-gray-400 rounded-xl p-1 group hover:bg-gradient-to-t from-[#0F6305] to-[#20A70F]'>
      <div className='w-full '>
        <img
          src={image}
          alt='Programer laptop'
          className='w-full aspect-video  rounded-xl group-hover:opacity-20'
          loading='lazy'
        />
      </div>
